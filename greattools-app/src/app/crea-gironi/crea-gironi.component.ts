...
import { shakeAnimation, shakeOnEnterAnimation, wobbleAnimation, wobbleOnEnterAnimation, zoomInDownOnEnterAnimation } from 'angular-animations';
...
@Component({
  ...
  animations: [
    zoomInDownOnEnterAnimation({ delay: 100 }),
    wobbleOnEnterAnimation({duration: 1000}),
